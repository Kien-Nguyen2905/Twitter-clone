...
export const loginController = async (req: Request<ParamsDictionary, any, LoginReqBody>, res: Response) => {
  ...
  const result = await usersService.login({ user_id: user_id.toString(), verify: UserVerifyStatus.Unverified })
  return res.json({
...
export const emailVerifyValidator = async (req: Request<ParamsDictionary, any, VerifyEmailReqBody>, res: Response) => {
